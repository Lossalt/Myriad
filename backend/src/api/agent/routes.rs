...
pub fn create_agent_routes(app_state: crate::state::AppState) -> Router<crate::state::AppState> {
    ...
    Router::<crate::state::AppState>::new()
        ...
        .route(
            "/telegram/status",
            get(get_telegram_bot_status).route_layer(from_fn_with_state(
                app_state.clone(),
                middleware::auth::auth_middleware,
            )),
        )
        .route(
            "/telegram/test",
            post(post_telegram_bot_test).route_layer(from_fn_with_state(
                app_state.clone(),
                middleware::auth::auth_middleware,
            )),
        )
        .route(
            "/telegram/pairing",
            get(get_telegram_pairing)
                .post(post_telegram_pairing)
                .delete(delete_telegram_pairing)
                .route_layer(from_fn_with_state(
                    app_state.clone(),
                    middleware::auth::auth_middleware,
                )),
        ...
        .route(
            "/discord/status",
            get(get_discord_bot_status).route_layer(from_fn_with_state(
                app_state.clone(),
                middleware::auth::auth_middleware,
            )),
        )
        .route(
            "/discord/test",
            post(post_discord_bot_test).route_layer(from_fn_with_state(
                app_state.clone(),
                middleware::auth::auth_middleware,
            )),
        )
        .route(
            "/discord/pairing",
            get(get_discord_pairing)
                .post(post_discord_pairing)
                .delete(delete_discord_pairing)
                .route_layer(from_fn_with_state(
                    app_state.clone(),
                    middleware::auth::auth_middleware,
                )),
        ...
        .route(
            "/feishu/status",
            get(get_feishu_bot_status).route_layer(from_fn_with_state(
                app_state.clone(),
                middleware::auth::auth_middleware,
            )),
        )
        .route(
            "/feishu/test",
            post(post_feishu_bot_test).route_layer(from_fn_with_state(
                app_state.clone(),
                middleware::auth::auth_middleware,
            )),
        )
        .route(
            "/feishu/pairing",
            get(get_feishu_pairing)
                .post(post_feishu_pairing)
                .delete(delete_feishu_pairing)
                .route_layer(from_fn_with_state(
                    app_state.clone(),
                    middleware::auth::auth_middleware,
                )),
